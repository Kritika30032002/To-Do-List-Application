...
<link
  ...
  <body>
    <a href="src/login.html" class="button">Login</a>
    <!-- Preloader Starts -->
    <div class="preloader">
  ...
  <script>
      var typed = new Typed('#element', {
          strings: ['To-Do List 📝', 'Organize tasks, boost daily productivity! 🚀.', 'Achieve Your Goals One Task at a Time 📃', 'Plan, Act, Achieve: Get Started Now! 😉..'],
          typeSpeed: 50,
      });
  </script>
  ...
  - To Edit Task: 'Edit task [old task] to [new task] due date [new due date] priority [new priority]'" class="btn btn-primary">Start Voice Command</button>
