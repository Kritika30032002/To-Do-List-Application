      ...
      if(email === ''){
        ...
        if (data) {
          if (data.errors) {
            ...
            setEmail(localStorage.setItem("email",values.email))
            if (data.isAdmin === "true") {
              
              navigate("/home");
            } else {
            //   <QuizPausereamail = {userEmail}/>
            return(
      ...
      <div className="login-card">
        <div className="card mt-5">
          ...
          <div className="card-body">
            ...
            <div className="mt-3">
              Don't have an account? <Link to="/" style={{color:"blue"}}>Register</Link>
            </div>
